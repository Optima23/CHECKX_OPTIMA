...
//     today.setMinutes(today.getMinutes());
    ...
    if (new Date("Mar 26, 2023 11:55:00") >= today && rollno != 205321004) {
      res.render(`${__dirname}/Client/livepage1.ejs`);
    }

    // (new Date("May 14 , 2022 19:30:00") <= today || name.round1done == 1) && rollno != 205321004
    else if ((new Date("Mar 26 , 2023 12:15:00") <= today || name.round1done == 1)&& rollno != 205321004) {
      res.render(`${__dirname}/Client/indexfrontlogout.ejs`);
    } else {
...
//     today.setMinutes(today.getMinutes());
    ...
    else if ((new Date("Mar 26, 2023 12:20:00") <= today || name.round1done == 0 || name.round2done == 1)&& rollno != 205321004) {
      res.render(`${__dirname}/Client/indexfrontlogout.ejs`);
    } else {
      name.round2done = 1;
      name.save();
